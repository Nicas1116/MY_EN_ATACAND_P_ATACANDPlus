...
- (BOOL) application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    PKPresentation* presentation = [PKPresentation presentationWithName:@"MY_EN_ATACAND_P_ATACANDPlus"];
    NSAssert(presentation != nil, @"Why is there no presentation named 'MY_EN_ATACAND_P_ATACANDPlus'?");
